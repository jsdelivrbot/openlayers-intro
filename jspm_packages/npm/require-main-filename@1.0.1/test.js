/* */ 
(function(process) {
  var requireMainFilename = require('../require-main-filename@1.0.1.json!systemjs-json');
  ...
  describe('require-main-filename', function() {
    ...
    it('should use children[0].filename when running on iisnode', function() {
      ...
      requireMainFilename({main: main}).should.match(/server\.js/);
    });
    it('should not use children[0] if no children exist', function() {
      ...
      requireMainFilename({main: main}).should.match(/interceptor\.js/);
    });
