...
(function(process) {
  ...
  var layouts = require('../lib/index');
  describe('metalsmith-layouts', function() {
    it('should render a basic template', function(done) {
      Metalsmith('test/fixtures/basic').use(layouts({engine: 'swig'})).build(function(err) {
        if (err) {
          return done(err);
        }
    ...
    it('should accept an engine string', function(done) {
      Metalsmith('test/fixtures/basic').use(layouts('swig')).build(function(err) {
        if (err) {
          return done(err);
        }
        equal('test/fixtures/basic/expected', 'test/fixtures/basic/build');
    ...
    it('should accept a pattern to match', function(done) {
      Metalsmith('test/fixtures/pattern').use(layouts({
        engine: 'swig',
        pattern: '*.md'
      })).build(function(err) {
        if (err) {
    ...
    it('should expose consolidate.requires', function(done) {
      Metalsmith('test/fixtures/basic').use(layouts({
        engine: 'swig',
    ...
    it('should accept a default template', function(done) {
      Metalsmith('test/fixtures/default').use(layouts({
        engine: 'swig',
        pattern: '*.md',
    ...
    it('should accept a different layouts directory', function(done) {
      Metalsmith('test/fixtures/directory').use(layouts({
        engine: 'swig',
        directory: 'templates'
      })).build(function(err) {
        if (err) {
    ...
    it('should mix in global metadata', function(done) {
      Metalsmith('test/fixtures/metadata').metadata({title: 'Global Title'}).use(layouts({engine: 'swig'})).build(function(err) {
        if (err) {
          return done(err);
        }
    ...
    it('should preserve binary files', function(done) {
      Metalsmith('test/fixtures/binary').use(layouts({engine: 'swig'})).build(function(err) {
        if (err) {
          return done(err);
        }
    ...
    it('should process swig includes', function(done) {
      Metalsmith('test/fixtures/include').use(layouts({engine: 'swig'})).build(function(err) {
        if (err) {
          return done(err);
        }
    ...
    it('should be capable of processing partials multiple times', function(done) {
      var instance = Metalsmith('test/fixtures/partials-multiple').use(layouts({
        engine: 'handlebars',
    ...
    it('should use partialExtension to limit the matching partial files', function(done) {
      var instance = Metalsmith('test/fixtures/partials-partialExtension').use(layouts({
        engine: 'handlebars',
    ...
    it('should find partials in subdirectories correctly', function(done) {
      var instance = Metalsmith('test/fixtures/partials-subdirectories').use(layouts({
        engine: 'handlebars',
        partials: 'layouts/partials'
      }));
      instance.build(function(err) {
    ...
    it('should accept a partials option', function(done) {
      Metalsmith('test/fixtures/partials-option').use(layouts({
        engine: 'handlebars',
        partials: 'partials'
      })).build(function(err) {
        if (err) {
    ...
    it('should ignore files without a layout', function(done) {
      Metalsmith('test/fixtures/ignore').use(layouts('handlebars')).build(function(err) {
        if (err) {
          return done(err);
        }
    ...
    it('should ignore files with layout: false', function(done) {
      Metalsmith('test/fixtures/layout-false').use(layouts({
        engine: 'handlebars',
        default: 'default.html'
      })).build(function(err) {
        if (err) {
    ...
    it('should not change file extension by default', function(done) {
      Metalsmith('test/fixtures/rename-option-default').use(layouts({engine: 'handlebars'})).build(function(err) {
        if (err)
          return done(err);
    ...
    it('should change file extension when rename option is set to true', function(done) {
      Metalsmith('test/fixtures/rename-option').use(layouts({
        engine: 'handlebars',
        rename: true
      })).build(function(err) {
        if (err)
    ...
    it('should change file extension for nested files when rename option is set to true', function(done) {
      Metalsmith('test/fixtures/rename-option-nested').use(layouts({
        engine: 'handlebars',
        rename: true
      })).build(function(err) {
        if (err)
