...
var opts = {
  ...
  banana: {full: "b-nana"},
  carrot: {string: '-c NUM, --carrots=NUM'},
  dill: {metavar: 'PICKLE'},
  egg: {
    position: 0,
    help: 'robin'
...
exports.testScriptName = function(test) {
  test.expect(1);
  nomnom().script("test").printer(function(string) {
...
exports.testUsage = function(test) {
  test.expect(1);
  parser.usage("test usage").printer(function(string) {
...
exports.testHidden = function(test) {
  test.expect(1);
  nomnom().options({file: {hidden: true}}).scriptName("test").printer(function(string) {
...
exports.testRequiredOptional = function(test) {
  ...
  }).scriptName("test").printer(function(string) {
