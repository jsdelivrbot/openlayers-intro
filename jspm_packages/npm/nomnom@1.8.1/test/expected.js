...
exports.testFlag = function(test) {
  test.expect(1);
  nomnom().options({file: {position: 0}}).printer(function(string) {
...
exports.testRequired = function(test) {
  test.expect(1);
  nomnom().options({file: {required: true}}).printer(function(string) {
...
exports.testChoices = function(test) {
  test.expect(2);
  var parser = nomnom().options({color: {choices: ['green', 'blue']}}).printer(function(string) {
