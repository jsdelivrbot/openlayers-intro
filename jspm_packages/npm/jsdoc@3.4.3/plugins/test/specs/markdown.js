...
(function(process) {
  ...
  describe('markdown plugin', function() {
    ...
    it('should process the correct tags by default', function() {
      ...
      [myClass.author[0], myClass.classdesc, myClass.description, myClass.exceptions[0].description, myClass.params[0].description, myClass.properties[0].description, myClass.returns[0].description, myClass.see].forEach(function(value) {
