...
}
{
  ...
  var allocators = [Buffer, SlowBuffer, Buffer.alloc, Buffer.allocUnsafe, Buffer.allocUnsafeSlow];
...
assert.throws(() => Buffer(-Buffer.poolSize), '"size" argument must not be negative');
assert.throws(() => Buffer(-100), '"size" argument must not be negative');
assert.throws(() => Buffer(-1), '"size" argument must not be negative');
