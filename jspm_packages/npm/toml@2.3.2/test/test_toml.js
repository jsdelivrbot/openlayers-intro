...
var easyTableArrayExpected = {"products": [{
    "name": "Hammer",
    "sku": 738594937
  }, {}, {
    "name": "Nail",
...
var hardTableArrayExpected = {"fruit": [{
    "name": "apple",
    "physical": {
      "color": "red",
      "shape": "round"
...
var badInputs = ['[error]   if you didn\'t catch this, your parser is broken', 'string = "Anything other than tabs, spaces and newline after a table or key value pair has ended should produce an error unless it is a comment"   like this', 'array = [\n           \"This might most likely happen in multiline arrays\",\n           Like here,\n           \"or here,\n           and here\"\n           ]     End of array comment, forgot the #', 'number = 3.14  pi <--again forgot the #'];
...
exports.testUnicode = function(test) {
  ...
  test.parsesToml(str, {str: "My name is Jos\u00E9"});
...
exports.testDate = function(test) {
  ...
  test.parsesToml("a = 1979-05-27T07:32:00Z", {a: date});
  test.done();
};
...
exports.testDateWithSecondFraction = function(test) {
  ...
  test.parsesToml("a = 1979-05-27T00:32:00.999999-07:00", {a: date});
  test.done();
};
exports.testDateFromIsoString = function(test) {
  var date = new Date(),
      ...
      tomlStr = "a = " + dateStr;
  test.parsesToml(tomlStr, {a: date});
  test.done();
};
exports.testLeadingNewlines = function(test) {
  var str = "\ntest = \"ing\"";
  test.parsesToml(str, {test: "ing"});
  test.done();
};
...
exports.testMoreComplexQuotedKeyNames = function(test) {
  ...
  test.parsesToml('[table]\n\'a "quoted value"\' = "value"', {table: {'a "quoted value"': "value"}});
  test.parsesToml('[module]\n"foo=bar" = "zzz"', {module: {"foo=bar": "zzz"}});
  test.done();
};
