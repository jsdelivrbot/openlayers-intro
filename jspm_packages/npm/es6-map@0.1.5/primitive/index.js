...
var clear = require('es5-ext/object/clear'),
    ...
    PrimitiveMap;
module.exports = PrimitiveMap = function() {
  ...
  forOf(iterable, function(value) {
    ...
    if (sKey == null)
      throw new TypeError(key + " cannot be serialized");
    value = value[1];
    if (hasOwnProperty.call(self.__mapKeysData__, sKey)) {
      if (self.__mapValuesData__[sKey] === value)
        return;
    } else {
      ++self.__size__;
    }
...
if (setPrototypeOf)
  setPrototypeOf(PrimitiveMap, MapPolyfill);
PrimitiveMap.prototype = create(MapPolyfill.prototype, {
  ...
  set: d(function(key, value) {
    ...
    if (sKey == null)
      throw new TypeError(key + " cannot be serialized");
    if (hasOwnProperty.call(this.__mapKeysData__, sKey)) {
      if (this.__mapValuesData__[sKey] === value)
        return this;
    } else {
      ++this.__size__;
    }
