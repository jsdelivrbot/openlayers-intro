...
var callable = require('es5-ext/object/valid-callable'),
    ...
    PrimitiveSet;
module.exports = PrimitiveSet = function() {
  ...
  forOf(iterable, function(value) {
    ...
    if (hasOwnProperty.call(self.__setData__, key))
      return;
...
if (setPrototypeOf)
  setPrototypeOf(PrimitiveSet, Set);
PrimitiveSet.prototype = create(Set.prototype, {
  ...
  add: d(function(value) {
    ...
    if (key == null)
      throw new TypeError(value + " cannot be serialized");
    if (hasOwnProperty.call(this.__setData__, key))
      return this;
