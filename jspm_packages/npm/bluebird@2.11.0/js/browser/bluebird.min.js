  ...
  !function(t) {
    ...
    return function n(t, e, r) {
      ...
      2: [function(t, e, r) {
        ...
        n.prototype.disableTrampolineIfNecessary = function() {
        ...
        }, h.hasDevTools ? (c.isStatic && (c = function(t) {
          setTimeout(t, 0);
        ...
        }) : (n.prototype.invokeLater = i, n.prototype.invoke = o, n.prototype.settlePromises = s), n.prototype.invokeFirst = function(t, e, r) {
          ...
          this._isTickUsed = !1;
        }, e.exports = new n, e.exports.firstLineError = a;
      }, {
        "./queue.js": 28,
        "./schedule.js": 31,
        "./util.js": 38
      ...
      10: [function(t, e, r) {
        ...
        e.exports = function(e, r) {
          ...
          return u.isNode && 0 == process.env.BLUEBIRD_DEBUG && (l = !1), l && s.disableTrampolineIfNecessary(), e.prototype._ignoreRejections = function() {
      ...
      11: [function(t, e, r) {
        ...
        e.exports = function(t) {
          ...
          t.prototype["return"] = t.prototype.thenReturn = function(r) {
            return void 0 === r ? this.then(n) : i(r) ? this._then(s(r, 2), void 0, void 0, void 0, void 0) : (r instanceof t && r._ignoreRejections(), this._then(e, void 0, void 0, r, void 0));
          }, t.prototype["throw"] = t.prototype.thenThrow = function(t) {
            return void 0 === t ? this.then(o) : i(t) ? this._then(s(t, 1), void 0, void 0, void 0, void 0) : this._then(r, void 0, void 0, t, void 0);
          };
        };
      }, {"./util.js": 38}],
      12: [function(t, e, r) {
      ...
      13: [function(t, e, r) {
        ...
        var j = Error.__BluebirdErrorTypes__;
        j || (j = u({
          CancellationError: f,
          TimeoutError: _,
          OperationalError: i,
          RejectionError: i,
          AggregateError: d
        }), h(Error, "__BluebirdErrorTypes__", j)), e.exports = {
          Error: Error,
          TypeError: o,
          RangeError: s,
          CancellationError: j.CancellationError,
          OperationalError: j.OperationalError,
      ...
      19: [function(t, e, r) {
        ...
        e.exports = function(e, r, n, i, o) {
          function s(t, e, r, n) {
            ...
            var i = c();
            this._callback = null === i ? e : i.bind(e), this._preservedValues = n === o ? new Array(this.length()) : null, this._limit = r, this._inFlight = 0, this._queue = r >= 1 ? [] : d, l.invoke(a, this, void 0);
          }
          function a() {
            this._init$(void 0, -2);
          }
          ...
          var c = e._getDomain,
              ...
              _ = {},
              d = [];
          h.inherits(s, r), s.prototype._init = function() {}, s.prototype._promiseFulfilled = function(t, r) {
            var n = this._values,
                o = this.length(),
            ...
            if (n[r] === _) {
              ...
              if (this._promise._popContext(), l === f)
                return this._reject(l.e);
              var h = i(l, this._promise);
              if (h instanceof e) {
                if (h = h._target(), h._isPending())
                  return a >= 1 && this._inFlight++, n[r] = _, h._proxyPromiseArray(this, r);
                if (!h._isFulfilled())
      ...
      23: [function(t, e, r) {
        ...
        e.exports = function() {
          function r(t) {
            if ("function" != typeof t)
              throw new p("the promise constructor requires a resolver function\n\n    See http://goo.gl/EC22Yn\n");
          ...
          i = u.isNode ? function() {
            ...
            return null;
          }, u.notEnumerableProp(r, "_getDomain", i);
          var c = {},
              l = t("./async.js"),
              h = t("./errors.js"),
          ...
          var f = function() {},
              _ = {},
              d = {e: null},
              v = t("./thenables.js")(r, f),
              y = t("./promise_array.js")(r, f, v, a),
              g = t("./captured_trace.js")(),
              m = t("./debuggability.js")(r, g),
              j = t("./context.js")(r, g, m),
              b = t("./catch_filter.js")(d),
              w = t("./promise_resolver.js"),
              k = w._nodebackForPromise,
              E = u.errorObj,
              F = u.tryCatch;
          return r.prototype.toString = function() {
            ...
            if (e > 1) {
              ...
              for (n = 0; e - 1 > n; ++n) {
                ...
                if ("function" != typeof s)
                  return r.reject(new p("Catch filter must inherit from Error or be a simple predicate function\n\n    See http://goo.gl/o84o68\n"));
                i[o++] = s;
              }
          ...
          }, r.prototype.then = function(t, e, r) {
            if (m() && arguments.length > 0 && "function" != typeof t && "function" != typeof e) {
          ...
          }, r.prototype.done = function(t, e, r) {
            var n = this._then(t, e, r, void 0, void 0);
            n._setIsFinal();
          }, r.prototype.spread = function(t, e) {
            return this.all()._then(t, e, void 0, _, void 0);
            ...
            return new y(this).promise();
          }, r.prototype.error = function(t) {
            return this.caught(u.originatesFromRejection, t);
          }, r.getNewLibraryCopy = e.exports, r.is = function(t) {
            ...
            if (!(e instanceof r)) {
              var n = e;
              e = new r(f), e._fulfillUnchecked(n);
            }
            return e;
            ...
            if ("function" != typeof t)
              throw new p("fn must be a function\n\n    See http://goo.gl/916lJJ\n");
            var e = l._schedule;
            return l._schedule = t, e;
          }, r.prototype._then = function(t, e, n, o, s) {
            var a = void 0 !== s,
                u = a ? s : new r(f);
            a || (u._propagateFrom(this, 5), u._captureStackTrace());
            var c = this._target();
            c !== this && (void 0 === o && (o = this._boundTo), a || u._setIsMigrated());
            var h = c._addCallbacks(t, e, n, u, o, i());
            return c._isResolved() && !c._isSettlePromisesQueued() && l.invoke(c._settlePromiseAtPostResolution, c, h), u;
            ...
            return e === c ? void 0 : void 0 === e && this._isBound() ? this._boundValue() : e;
            ...
            var n = t._fulfillmentHandlerAt(e),
                ...
                s = t._promiseAt(e),
                a = t._receiverAt(e);
            s instanceof r && s._setIsMigrated(), void 0 === a && (a = c), this._addCallbacks(n, i, o, s, a, null);
          }, r.prototype._addCallbacks = function(t, e, r, n, i, o) {
            var s = this._length();
          ...
          }, r.prototype._rejectCallback = function(t, e, r) {
            ...
            r = !1, this._popContext(), void 0 !== n && n === E && null !== e && (e._rejectCallback(n.e, !0, !0), e = null);
          }, r.prototype._settlePromiseFromHandler = function(t, e, r, n) {
            if (!n._isRejected()) {
              n._pushContext();
              var i;
              if (i = e !== _ || this._isRejected() ? F(t).call(e, r) : F(t).apply(this._boundValue(), r), n._popContext(), i === E || i === n || i === d) {
                var s = i === n ? o() : i.e;
            ...
            var e = this._promiseAt(t),
                n = e instanceof r;
            if (n && e._isMigrated())
              return e._unsetIsMigrated(), l.invoke(this._settlePromiseAt, this, t);
            ...
            this._clearCallbackDataAtIndex(t), "function" == typeof i ? n ? this._settlePromiseFromHandler(i, a, s, e) : i.call(a, s, e) : a instanceof y ? a._isResolved() || (this._isFulfilled() ? a._promiseFulfilled(s, e) : a._promiseRejected(s, e)) : n && (this._isFulfilled() ? e._fulfill(s) : e._reject(s, o)), t >= 4 && 4 === (31 & t) && l.invokeLater(this._setLength, this, 0);
            ...
            l.settlePromises(this), this._setSettlePromisesQueued();
            ...
            return this._setRejected(), this._settledValue = t, this._cleanValues(), this._isFinal() ? void l.throwLater(function(t) {
              throw "stack" in t && l.invokeFirst(g.unhandledRejection, void 0, t), t;
      ...
      25: [function(t, e, r) {
        ...
        function i(t) {
          var e;
          if (n(t)) {
            e = new h(t), e.name = t.name, e.message = t.message, e.stack = t.stack;
            for (var r = f.keys(t),
                i = 0; i < r.length; ++i) {
              var o = r[i];
              _.test(o) || (e[o] = t[o]);
        ...
        var s,
            ...
            c = t("./errors.js"),
            l = c.TimeoutError,
            h = c.OperationalError,
            p = a.haveGetters,
            f = t("./es5.js"),
            _ = /^(?:name|message|stack|cause)$/;
        if (s = p ? function(t) {
          this.promise = t;
        } : function(t) {
          ...
          f.defineProperty(s.prototype, "asCallback", d), f.defineProperty(s.prototype, "callback", d);
        }
          ...
          function c(t, e, r, n) {
            for (var i = new RegExp(E(e) + "$"),
              ...
              if (n === F)
                ...
                f.notEnumerableProp(_, "__isPromisified__", !0), t[h] = _;
              }
            }
        ...
        e.exports = function(e, r, n, i, o) {
          function s(t, r, n, s) {
            ...
            var u = i(n, this._promise),
                h = !1,
                p = u instanceof e;
            p && (u = u._target(), u._isPending() ? u._proxyPromiseArray(this, -1) : u._isFulfilled() ? (n = u._value(), this._gotAccum = !0) : (this._reject(u._reason()), h = !0)), p || this._zerothIsAccum || (this._gotAccum = !0);
            var f = c();
            this._callback = null === f ? r : f.bind(r), this._accum = n, h || l.invoke(a, this, void 0);
          }
          function a() {
            this._init$(void 0, -5);
          }
          ...
          var c = e._getDomain,
              ...
              p = h.tryCatch,
              f = h.errorObj;
          h.inherits(s, r), s.prototype._init = function() {}, s.prototype._resolveEmptyArray = function() {
            ...
            if (o = l[r], 0 === r && this._zerothIsAccum ? (this._accum = t, this._gotAccum = c = !0, l[r] = 0 === o ? 1 : 2) : -1 === r ? (this._accum = t, this._gotAccum = c = !0) : 0 === o ? l[r] = 1 : (l[r] = 2, this._accum = t), c) {
              for (var h,
                ...
                if (o = l[v], 2 !== o) {
                  if (1 !== o)
                    return;
                  if (t = n[v], this._promise._pushContext(), u ? (a.push(t), h = p(_).call(d, t, v, s)) : h = p(_).call(d, this._accum, t, v, s), this._promise._popContext(), h === f)
      ...
      31: [function(t, e, r) {
        ...
        if (i.isNode && "undefined" == typeof MutationObserver) {
          var s = global.setImmediate,
              a = process.nextTick;
          n = i.isRecentNode ? function(t) {
            s.call(global, t);
          } : function(t) {
            a.call(process, t);
          };
        } else
          "undefined" == typeof MutationObserver || "undefined" != typeof window && window.navigator && window.navigator.standalone ? n = "undefined" != typeof setImmediate ? function(t) {
            setImmediate(t);
        ...
        e.exports = function(e, r) {
          ...
          var o = t("./util.js"),
              ...
              a = function(t, e) {
                if (t.isPending()) {
                  var r;
                  !o.isPrimitive(e) && e instanceof Error ? r = e : ("string" != typeof e && (e = "operation timed out"), r = new s(e)), o.markAsOriginatingFromRejection(r), t._attachExtraTrace(r), t._cancel(r);
                }
              },
              u = function(t) {
      ...
      37: [function(t, e, r) {
        ...
        e.exports = function(e, r, n, i) {
          ...
          h.prototype.data = function() {
            ...
            for (var u = new Array(t),
                p = 0; t > p; ++p) {
              var _ = s[p];
              if (h.isDisposer(_)) {
                var d = _;
                _ = _.promise(), _._setDisposable(d);
              } else {
                var v = n(_);
