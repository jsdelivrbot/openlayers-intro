...
(function(process) {
  ...
  module.exports = function(args, opts) {
    var argv = subarg(args, {
      'boolean': ['deps', 'pack', 'ig', 'dg', 'im', 'd', 'list', 'builtins', 'commondir', 'bare', 'full-paths', 'bundle-external', 'bf', 'node'],
    ...
    [].concat(argv.external).filter(Boolean).forEach(function(x) {
      ...
      function add(x, opts) {
        if (/^[\/.]/.test(x))
          b.external(path.resolve(x), opts);
        else
          b.external(x, opts);
      }
    });
    ...
    function addTransform(t, opts) {
      if (typeof t === 'string' || typeof t === 'function') {
        ...
        error('unexpected transform of type ' + typeof t);
    }
